package com.bank.bian.quotemanagement.model;
...
/**
 * The BIAN control record for this service domain: "Market Quote Management Plan".
 *
 ...
 * to its asset type (Market Quote). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Market Quote Management Plan";
